...
const RightSidebar: React.FC<RightSidebarProps> = ({ isRegular }) => {
  return (
    <div className='mb-2'>
      <div className='w-full lg:w-[17vw] px-2 pt-10 overflow-y-scroll h-full'>
        ...
        <BorderBox className='mb-5'>
          ...
          {isRegular === "1" &&
            <div className='flex flex-col gap-2.5 p-2'>
              <div className='flex items-center text-[14px]'>
                Presale Progress Bar 0.453 <InfoSvg className='ml-2' />
              </div>
              <Progress
                color='green'
          ...
          <div className={'flex p-2' + (isRegular === "1" ? ' border-t border-borderColor' : '')}>
        ...
        <BorderBox className='p-3'>
          {isRegular === "1" ?
            <div className='flex flex-col gap-5'>
              <button className='p-2 bg-pink text-white rounded-lg'>
                Withdraw Fund
              </button>
