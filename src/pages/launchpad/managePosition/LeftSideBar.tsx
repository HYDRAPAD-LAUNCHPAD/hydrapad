  ...
  return (
    <div className='py-8 border-r pt-[90px] border-r-borderColor relative'>
      ...
      <div className='px-3 flex flex-col items-center w-full xl:w-[17vw]'>
        ...
        {isRegular === "1" ?
          <>
            <button className={clsx("w-full text-[14px] bg-green1 rounded-lg font-primary px-5 py-2", "")}>
              Withdraw Presale Token
            </button>
            <button className={clsx("w-full text-[14px] bg-green-500 rounded-lg font-primary px-5 py-2 mt-2.5", "")}>
