...
const TokenInfo: React.FC<PropsType> = ({ form, setForm }) => {
  ...
  const handleBack = () => {
    navigate("/create-token/with-presale/second-step")
  }
  ...
  return (
    <div className="w-full md:w-1/2 mb-20 md:mb-0 px-8">
      ...
      <div className="mb-5">
        <LabelText>Total amount of token for Presale:</LabelText>
        <CustomInput placeholder="Enter amount of token for Presale" />
      </div>
      <div className="mb-5">
